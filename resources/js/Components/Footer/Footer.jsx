            ...
            <div className="container-size">
                ...
                <div class="container-flex">
                    ...
                    <div className="size-support">
                        <h2 class="typography-support-politics">Soporte</h2>
                        <ul>
                    ...
                    <div className="size-politics">
                        <h2 class="typography-support-politics">Políticas</h2>
                        <ul>
                            <li>
                                <a
                                    href="#"
                                    class="hover:underline support-text"
                                >
                ...
                <hr class="mx-11 my-11" />

                <div class="sm:flex sm:items-center sm:justify-between mx-11 pb-12">
                    <span class="flex text-sm text-white sm:text-center">
                    ...
                    <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        ...
                        <a href="https://www.youtube.com/@LicitacionesInfo">
                            <svg
                                class="w-6 h-7"
                                fill="currentColor"
                                viewBox="0 0 24 24"
