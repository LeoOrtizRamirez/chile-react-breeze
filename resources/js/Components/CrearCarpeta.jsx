...
const CrearCarpeta = ({ showModal, handleCloseModal }) => {
    const { data, setData, post, processing, reset, errors } = useForm({
        nombre_carpeta: "",
        icono: "icon-Mis-carpetas",
        color: "",
        orden: "",
    });
    ...
    return (
        <Modal show={showModal} onHide={handleCloseModal} centered size='lg' id="modal_crear_carpeta">
            <Modal.Header>
                <Modal.Title>
                    <h4 className="modal-title">Crear carpeta.</h4>
            ...
            <Modal.Body>
                <form novalidate="novalidate" className="text-center" onSubmit={submit}>
                            ...
                            <div className="crear_carpeta__colors">
                                ...
                                <div className="crear_carpeta__item_colors">
                                    <label className="color_active">
                                        <input type="radio" name="color" value="" onClick={(e) => setData("color", e.target.value)} checked={data.color == "" ? true : false} />
                    ...
                    <div class="btnsModal text-center">
                        ...
                        <button type="submit" class="btnRadius btn-new-green">Crea una carpeta</button>
                    </div>
                </form>
            </Modal.Body>
        </Modal>
