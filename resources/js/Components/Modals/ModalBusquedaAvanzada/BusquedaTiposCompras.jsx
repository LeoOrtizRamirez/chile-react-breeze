        ...
        >
            <>
                <Modal.Header closeButton className="header">
                    <h2 className="name_section_app-mbtp">
                ...
                >
                    <div className="bg-white overflow-auto w-full text-center margen-superior custom-scroll-mbtp">
                        <div className="container mt-4">
                            <div className="tree_categorias-mbtp tree_1">
                                <div className="tree_categorias-mbtp__busqueda-mbtp mb-3 mb-md-4">
                                    <div className="mx-60 mt-30 d-flex">
                                        ...
                                        <input
                                            ...
                                            autoComplete="off"
                                            className="form-control-mbtp busqueda-input"
                                            onKeyDown={inputSearchTipoCompra}
                                        />
                                    </div>
                                    <div>
                                        <ul className="tree-root-mbtp">
                                            {sectores.map((sector) => (
                                                <>
                                                    {sector.id_padre_sub_categoria ==
                                                        null && (
                                                        <li
                                                            className={`tree-node-mbtp has-child draggable ${
                                                        ...
                                                        >
                                                            <div
                                                                id={sector.id}
                                                                className="tree-content-mbtp mt-3 sector"
                                                                key={sector.id}
                                                            >
                                                                <i
                                                                    className={`tree-arrow-mbtp has-child ${
                                                                        sector
                                                                            .childs
                                                                            .length >
                                                                        0
                                                                ...
                                                                />
                                                                <span className="tree-anchor-mbtp">
                                                                    <span
                                                                        className="tree-division-mbtp tree-division-mbtp1"
                                                                        onClick={() =>
                                                                            getSegmento(
                                                                                sector.id
                                                                            )
                                                                    ...
                                                                    >
                                                                        <span className="tree-division-mbtp__title my-auto">
                                                                            {
                                                                                sector.nombre
                                                                            }
                                                                        </span>
                                                            ...
                                                            {openSectores.includes(
                                                                ...
                                                                <ul className="tree-children-mbtp new-class">
                                                                    {segmentos.map(
                                                                        (
                                                                            segmento,
                                                                            index
                                                                            ...
                                                                            <>
                                                                                {sector.id ==
                                                                                    ...
                                                                                    <li
                                                                                        className={`tree-node-mbtp has-child draggable segmento ${
                                                                                    ...
                                                                                    >
                                                                                        <div className="tree-content-mbtp segmento">
                                                                                            <i className="tree-arrow-mbtp expanded has-child ltr"></i>
                                                                                            <input
                                                                                                id={
                                                                                                    "segmento_check_" +
                                                                                                    segmento.id
                                                                                            ...
                                                                                            />
                                                                                            <span className="tree-anchor-mbtp">
                                                                                                <span className="tree-division-mbtp tree-division-mbtp1">
                                                                                                    <>
                                                                                                        {index %
                                                                                                            2 ==
                                                                                                        0 ? (
                                                                                                            ...
                                                                                                            <span className="tree-division-mbtp__title-gray my-auto">
                                                                                                                {
                                                                                                                    segmento.nombre
                                                                                                                }
                                                                                                            </span>
