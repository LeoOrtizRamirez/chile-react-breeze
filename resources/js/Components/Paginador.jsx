        ...
        <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
          <div>
            <p className="text-sm text-gray-700">
              <span className="font-medium">Página {props.currentPage+1}</span> - <span className="font-medium">{props.totalPaginas}</span> de <span className="font-medium">{props.totalElementos}</span> Resultados </p>
          </div>
          <div>
