                                            ...
                                            <div className="navegacion-contactenos--text-content">
                                                ...
                                                <Accordion>
                                                    ...
                                                    <Accordion.Item eventKey="4">
                                                        ...
                                                        <Accordion.Body>
                                                        <div class="card-body">
                                                            <p class="card-text">En la actualidad ponemos a tu disposición diferentes maneras para consultar los procesos de contratación:<br/><br/><span class="navegacion-contactenos--content-text-acordeon-bold">CORREO ELECTRÓNICO:</span> Enviamos de manera permanente y oportuna la información de los procesos y las novedades de su interés al correo electrónico registrado. <br/><br/><span class="navegacion-contactenos--content-text-acordeon-bold">PLATAFORMA WEB:</span> En la sesión de usuario tendrás a disposición todos los procesos de contratación, así como las herramientas necesarias para administrar dicha información en pro de alcanzar tus resultados <a href="www.lictacionescolombia.info" target="_blank">www.lictacionescolombia.info</a>. <br/><br/><span class="navegacion-contactenos--content-text-acordeon-bold">APLICATIVO MÓVIL:</span> Combina la capacidad informativa del correo electrónico con la portabilidad de un equipo móvil y todas las ventajas de nuestro servicio sin depender de un computador. <br/><br/><span class="navegacion-contactenos--content-text-acordeon-bold">API:</span> Puedes conectar la interfaz de usuario desarrollada por tu compañía a nuestros sistemas de transmisión de datos para que optimices procesos y recursos en tu equipo de trabajo.</p>
                                                        </div>
                                                        </Accordion.Body>
                                                    </Accordion.Item>
