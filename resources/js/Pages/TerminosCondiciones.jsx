        ...
        <>
            ...
            <section id="planes" className="planes planes-container customers-planes container">
                ...
                <div className="grid grid-cols-12 mt-4">
                    <div className="col-span-4 menu-izquierdo">A</div>
                    <div className="col-span-8 ">
                        ...
                        <h3 className="policy-subtitle">Definiciones</h3>
                        ...
                        <h3 className="policy-subtitle">Condiciones generales de uso del servicio</h3>
                        ...
                        <h3 className="policy-subtitle">Niveles de servicio</h3>
                        ...
                        <h3 className="policy-subtitle">Registro</h3>
                        ...
                        <h3 className="policy-subtitle">Activación del servicio</h3>
                        ...
                        <h3 className="policy-subtitle">Soporte al usuario</h3>
                        ...
                        <h3 className="policy-subtitle">Planes ofrecidos</h3>
                        ...
                        <h3 className="policy-subtitle">Perfiles de negocio</h3>
                        ...
                        <h3 className="policy-subtitle">Sistema de subcuentas</h3>
                        ...
                        <h3 className="policy-subtitle">Sistema de seguiemiento</h3>
                        ...
                        <h3 className="policy-subtitle">Notificaciones al correo electrónico</h3>
                        ...
                        <h3 className="policy-subtitle">Contratos especiales</h3>
                        ...
                        <h3 className="policy-subtitle">App móvil</h3>
                        ...
                        <h3 className="policy-subtitle">Limitación de la responsabilidad</h3>
                        ...
                        <h3 className="policy-subtitle">Cancelación de la cuenta</h3>
                        ...
                        <h3 className="policy-subtitle">Desarrollo de aplicativos</h3>
                        ...
                        <h3 className="policy-subtitle">Aceptación de estas condiciones</h3>
