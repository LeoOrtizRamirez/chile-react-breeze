        ...
        <AuthenticatedLayout auth={auth}>
            ...
            <div className="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
                <form onSubmit={submit}>
                    ...
                    <input
                        value={data.idplan}
                        onChange={(e) => setData("idplan", e.target.value)}
                        type="number"
                        placeholder="idplan"
                        autoFocus
                        className="mb-3 block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                    />
                    <InputError message={errors.idplan} className="mt-2" />
                    <input
                        value={data.email}
                    ...
                    <input
                        ...
                        className="mb-3 block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                    />
                    <InputError message={errors.nit_empresa} className="mt-2" />
                    <input
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            setData("telefono_fijo_empresa", e.target.value)
                        }
                        type="text"
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            setData("email_facturacion_empresa", e.target.value)
                        }
                        type="text"
